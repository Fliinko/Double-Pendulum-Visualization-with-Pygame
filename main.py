...
while run:
    ...
    accel1 = formular.FirstAcceleration(angle1, angle2, mass1, mass2, length1, length2, Gravity, velocity1, velocity2)
    accel2 = formular.SecondAcceleration(angle1, angle2, mass1, mass2, length1, length2, Gravity, velocity1, velocity2)
